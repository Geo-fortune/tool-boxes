...
class LidarCalibParams : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:calibration.LidarCalibParams) */ {
 ...
 private:
  ...
  mutable int _image_size_cached_byte_size_;
  ::google::protobuf::RepeatedField< float > xyz_range_;
  mutable int _xyz_range_cached_byte_size_;
  ::google::protobuf::RepeatedField< float > project_matrix_;
  mutable int _project_matrix_cached_byte_size_;
  ::google::protobuf::RepeatedField< float > lidar_init_rot_;
  mutable int _lidar_init_rot_cached_byte_size_;
  ::google::protobuf::RepeatedField< float > lidar_origin_;
  mutable int _lidar_origin_cached_byte_size_;
...
inline bool Config::has_rosbag_params() const {
  return this != internal_default_instance() && rosbag_params_ != NULL;
}
...
inline bool Config::has_lidar_calib_params() const {
  return this != internal_default_instance() && lidar_calib_params_ != NULL;
}
...
inline bool Config::has_camera_calib_params() const {
  return this != internal_default_instance() && camera_calib_params_ != NULL;
}
...
inline bool Config::has_marker_board_params() const {
  return this != internal_default_instance() && marker_board_params_ != NULL;
}
...
inline ::std::string* RosbagParams::release_bag_file() {
  ...
  return bag_file_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* RosbagParams::release_save_pth() {
  ...
  return save_pth_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* RosbagParams::release_image_topic() {
  ...
  return image_topic_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* RosbagParams::release_cloud_topic() {
  ...
  return cloud_topic_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
inline ::std::string* CameraCalibParams::release_camera_config_path() {
  ...
  return camera_config_path_.ReleaseNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
